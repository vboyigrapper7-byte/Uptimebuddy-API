const { createOrder, createSubscription, verifyPayment, getPlans } = require('./controller');
...
async function billingRoutes(fastify, options) {
    ...
    fastify.post('/create-subscription', { preHandler: [requireAuth] }, createSubscription);
